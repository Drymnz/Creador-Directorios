...
void MenuPrincipal::menu(string limiteS, string limiteI,string nombreA,string nombreEA)
{
    this->forLine(spect, icon);
    this->println("Limites -> Superior: <"+limiteS+"> Inferior:<"+limiteI+">");
    this->println("La direccion de archivo de salida es :"+nombreA+"."+nombreEA);
...
void MenuPrincipal::configuraciones(string limiteS, string limiteI,string nombreA,string nombreEA){
    this->forLine(spect, icon);
    this->println("Limites -> Superior: <"+limiteS+"> Inferior:<"+limiteI+">");
    this->println("La direccion de archivo de salida es :"+nombreA+"."+nombreEA);
